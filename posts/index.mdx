...
Players are not expecting a solution
and developers are rightfully wary of state-space explosions. <SideNote>As NPC behavioural complexity increases, so too does the Game's possible number of states.</SideNote>
