...
As NPC behavioural complexity increases, so too does the Game's possible number of states.
...
It must be interwoven with the Player's experience, as opposed to being an independent set of "plans".
