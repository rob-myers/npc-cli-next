...
because the underlying problem only makes sense when human behaviour can be expressed.
...
further restricted by their time-limited existence.
...
Freely combining behaviours naturally leads to state-space explosions.<SideNote>Even in very restricted settings e.g. [Conway's Game of Life](https://en.wikipedia.org/wiki/Conway%27s_Game_of_Life).</SideNote>
