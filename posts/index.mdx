...
> Because it's too damn hard: freely combining behaviours yields state-space explosions.
...
This is essentially the underlying problem, where a human Game Master controls the NPCs rather than an "automated director".
